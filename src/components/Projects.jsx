...
const Projects = () => {
            ...
            {proj2 ? (
              ...
              >
                <SwiperSlide>
                  <div className="flex flex-col">
                    <img name="slide" className="rounded-b-lg" src={Project3} alt="Project_image" />
                    <div className="flex md:flex-row gap-1 flex-col  md:w-[50%] h-[58%] p-2 border-2 bg-gradient-to-b2 from-[#8b8574] to-[#FFEAD7] rounded-xl m-auto">
                      <div className=" md:w-[50%] ">
  ...
  <div className="child-1 rounded-t-lg shadow-md shadow-[#8b8574] duration-300 col-start-2 col-span-4 bg-gray-800 hover:bg-gray-900 p-3 border-2 border-[#8b8574] "><div className="text-[#e5dcc2] font-medium w-fit mx-auto">Clean & Optimized Code</div></div>
  <div className="child-2 rounded-l-lg shadow-md shadow-[#8b8574] duration-300 col-start-1 col-end-3 bg-gray-800 hover:bg-gray-900 p-3 border-2 border-[#8b8574]"><div className="text-[#e5dcc2] font-medium w-fit mx-auto">Lesser Bugs</div></div>
<div className="m-auto col-start-3 col-span-2"> <div className="font-semibold text-[#e5dcc2] text-xl border-b-2 border-gray-500 ">PROJECT GOALS </div></div>
  <div className="child-3 rounded-r-lg shadow-md shadow-[#8b8574] duration-300 col-end-7 col-span-2 bg-gray-800 hover:bg-gray-900 p-3 border-2 border-[#8b8574]"><div className="text-[#e5dcc2] font-medium w-fit mx-auto">Better SEO</div></div>
  <div className="child-4 rounded-b-lg shadow-md shadow-[#8b8574] duration-300 col-start-1 col-end-7 bg-gray-800 hover:bg-gray-900 p-3 border-2 border-[#8b8574]"><div className="text-[#e5dcc2] font-medium w-fit mx-auto">High Performance & ReUsable</div></div>
</div>
